...
#    print(x_bar)
    ...
    #################################
    # r^2 mod n to m*r mod n
    m22=monPro2(r2modn,m)
    print("m22:\t")
    print(str(hex(m22)))
    ...
    e_str = e_str[2:]
    len_e_str = len(e_str)
    #a2=0x6c12931d6fcef9efe8b071820c7fa398
    #print("a = b = %s\n" % (str(hex(a2))))
    #a2 = monPro2(a2, a2)
...
#m=0x0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
m=0x18C7A5B52BF588C00A099CF1F6C42DA4    
e=0x819D451512390089590AF8BB46DB0001
n=0X819DC6B2574E12C3C8BC49CDD79555FD
...
#print("0x7637EA28188632D8F2D92845DB649D14\t")
